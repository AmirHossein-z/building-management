<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <?php if($_SESSION['role'] === 'role-manager') { ?>
        <a class="nav-link <?php echo ($_GET['url'] === 'dashboard/building_units_list_manage') ? '' : 'collapsed' ?>" href="<?php echo URL ?>dashboard/building_units_list_manage">
          <i class="bi bi-menu-button-wide"></i><span>لیست واحد های ساختمان شما</span>
        </a>
      <?php } ?>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link <?php echo ($_GET['url'] === 'dashboard/bills') ? '' : 'collapsed' ?>" href="<?php echo URL ?>dashboard/bills">
        <i class="bi bi-menu-button-wide"></i><span>لیست قبض های من</span>
      </a>
    </li>
