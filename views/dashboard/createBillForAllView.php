<div class="card">
    <div class="card-body">
        <h5 class="card-title">
            <span>ایجاد قبض برای همه واحد های فعال</span>
        </h5>

        <form method="POST" action="<?php echo URL ?>dashboard/created_bill_for_all">
            ...
            <input type="hidden" name="building_id" value="<?php echo $data['building_id']; ?>" />
