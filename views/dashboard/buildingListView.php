        ...
        <table class="table table-hover">
          ...
          <tbody>
            <?php foreach($data['buildings'] as $index => $building) { ?>
                <tr>
                  <th scope="row"><?php echo (int) ($index) + 1; ?></th>
                  <td><?php echo $building['name'] ?></td>
                  <td><?php echo $building['person_name'] ?></td>
                  <td><a class="btn btn-success" href="<?php echo URL; ?>dashboard/building_units_list/<?php echo $building['id']; ?>">لیست واحد ها</a></td>
                </tr>
            <?php } ?>
          </tbody>
        </table>
