        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3" style="background: rgba(255, 255, 255, 0.14);border-radius: 16px;box-shadow: 0 4px 30px rgba(0,0, 0, 0.1);backdrop-filter: blur(6.9px);-webkit-backdrop-filter: blur(6.9px);border: 1px solid rgba(255, 255, 255, 0.23);">
                ...
                <div class="card-body">
                  ...
                  <div class="col-sm-10 text-white">
                    ...
                    <p class="small mb-0 text-white">حساب ندارید؟<a class="text-decoration-underline" href="<?php echo URL.'auth/register' ?>">ساخت حساب کاربری</a></p>
                    </div>
                  </form>
